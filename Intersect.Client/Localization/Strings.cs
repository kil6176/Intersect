    ...
    public static class Strings
    {
        ...
        public struct Controls
        {
            ...
            public static Dictionary<string, LocalizedString> controldict = new Dictionary<string, LocalizedString>
            {
                ...
                {"hotkey10", @"Hot Key Numpad0:"},
                {"hotkey11", @"Hot Key Numpad1:"},
                {"hotkey12", @"Hot Key Numpad2:"},
                {"hotkey13", @"Hot Key Numpad3:"},
                {"hotkey14", @"Hot Key Numpad4:"},
                {"hotkey15", @"Hot Key Numpad5:"},
                {"hotkey16", @"Hot Key Numpad6:"},
                {"hotkey17", @"Hot Key Numpad7:"},
                {"hotkey18", @"Hot Key Numpad8:"},
                {"hotkey19", @"Hot Key Numpad9:"}
            };
