...
namespace Intersect.Client.Core.Controls
{
    ...
    public class Controls
    {
        ...
        public void ResetDefaults()
        {
            ...
            CreateControlMap(Control.Hotkey10, Keys.NumPad0, Keys.None);
            CreateControlMap(Control.Hotkey11, Keys.NumPad1, Keys.None);
            CreateControlMap(Control.Hotkey12, Keys.NumPad2, Keys.None);
            CreateControlMap(Control.Hotkey13, Keys.NumPad3, Keys.None);
            CreateControlMap(Control.Hotkey14, Keys.NumPad4, Keys.None);
            CreateControlMap(Control.Hotkey15, Keys.NumPad5, Keys.None);
            CreateControlMap(Control.Hotkey16, Keys.NumPad6, Keys.None);
            CreateControlMap(Control.Hotkey17, Keys.NumPad7, Keys.None);
            CreateControlMap(Control.Hotkey18, Keys.NumPad8, Keys.None);
            CreateControlMap(Control.Hotkey19, Keys.NumPad9, Keys.None);
