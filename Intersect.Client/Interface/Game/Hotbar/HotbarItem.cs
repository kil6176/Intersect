...
namespace Intersect.Client.Interface.Game.Hotbar
{
    ...
    public class HotbarItem
    {
        ...
        public void Update()
        {
            ...
            {
                if (mHotKey != Controls.ActiveControls.ControlMapping[Control.Hotkey10 + mYindex2].Key1)
                {
                    KeyLabel.SetText(
                        Strings.Keys.keydict[
                            Enum.GetName(
                                    typeof(Keys), Controls.ActiveControls.ControlMapping[Control.Hotkey10 + mYindex2].Key1
                                )
                                .ToLower()]
                    );

                    mHotKey = Controls.ActiveControls.ControlMapping[Control.Hotkey10 + mYindex2].Key1;
                }
            }
